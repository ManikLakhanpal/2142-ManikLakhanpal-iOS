...
var manik = User(name: "Manik", age: 20, height: 175.0, weight: 68.0, activityLevel: 8)
print("Name: \(manik.name), Age: \(manik.age), Height: \(manik.height), Weight: \(manik.weight), Activity Level: \(manik.activityLevel)")
