...
class Fighter: Spaceship {
    ...
    func fire() {
        if remainingFirePower > 0 {
            print("Fire \(remainingFirePower)")
            remainingFirePower -= 1
        } else {
            print("You dont have enough fire power")
        }
    }
}
...
let destroyter = Fighter()
destroyter.weapon = "Lazer"
destroyter.remainingFirePower = 5

destroyter.name = "Destroyer"
print(destroyter.position)
destroyter.moveRight()
